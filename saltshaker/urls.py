...
import dashboard,minions,execute,jobs,states_config,code_update,groups,system_setup,account,jenkins_wrapper
...
urlpatterns = [
    ...
    url(r'jenkins_wrapper/', include('jenkins_wrapper.urls')),
    url(r'svn_wrapper/',include('svn_wrapper.urls')),
]
